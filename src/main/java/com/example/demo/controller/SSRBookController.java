...
public class SSRBookController {
	...
	// 新增書籍 //model.addAttribute(...) 把資料放進去，讓 JSP 頁面可以讀取這些資料顯示在畫面上。
	@PostMapping("/add")
	public String addBook(Book book, Model model) {
		...
		return "redirect:/ssr/book"; // 會重跑這一頁,這樣才看的到瀏覽器剛才新增的內容
	...
	// 修改書籍
	@PutMapping("/edit/{id}")
	public String editBook(@PathVariable("id") Integer id, Book book, Model model) {
		try {
